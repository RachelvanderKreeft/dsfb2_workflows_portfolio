---
title: "4b_artikel_beoordelen_op_reproduceerbaarheid"
...
Het artikel dat onderzocht wordt is 'Infectivity and fatality of influenza in pre- and post-COVID-19 pandemic year', geschreven door Shuanglin Jing en Hao Wang.
\
\
Link naar artikel:
...
/
Ik heb geprobeerd om figuur 1E zoveel mogelijk te produceren in Rstudio. Hiervoor heb ik het bestand Death data(18-64).xlsx gebruikt. Dit bestand is hier te vinden: /
