...
exp1_11122025_bracken_species_threshold0 <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_bracken_species_threshold0.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
exp1_11122025_bracken_species_threshold5 <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_bracken_species_threshold5.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
exp1_11122025_bracken_species_patienten <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_bracken_species_patienten.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
exp1_11122025_bracken_species_controle <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_bracken_species_controle.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
exp1_11122025_bracken_species_threshold50 <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_bracken_species_threshold50.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
exp1_11122025_kraken2_species_threshold0 <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/16S_exp1_11122025_kraken2_species_threshold0.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
```{r , echo=FALSE, fig.height=3, out.width= '100%', fig.cap="Figuur 10: Per base sequence quality distributie voor mock1 data van daur2. Links; kwaliteitscores van de forward reads, de kwaliteitsscore is 36 op de Phred-schaal. Rechts; Kwaliteitsscores van de reverse reads, de kwaliteitsscore varieert van 25 tot 36 op de Phred-schaal. Alle basen hebben aflezingen van zeer hoge kwaliteit (>30), wat aangeeft dat de reads een nauwkeurigheid hebben van >99,9%." }

fastqc_forward <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/fastqc_mock2_R1_per_base_quality.png")))
fastqc_reverse <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/fastqc_mock2_R2_per_base_quality.png")))
grid.arrange(fastqc_forward, fastqc_reverse, ncol=2, top=textGrob("Per base quality distribution van forward (left) en reverse (right) reads", gp=gpar(fontsize=10,font=8)))
...
```{r, echo=FALSE, fig.cap="Figuur 11: Krona visualisatie op species niveau en een threshold van 0."}

# Importeer mock1_kraken_bracken_species_threshold0.png
mock1_kraken_bracken_species_threshold0 <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/mock1_kraken_bracken_species_threshold0.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
...
```{r, echo=FALSE, fig.cap="Figuur 12: Krona visualisatie op species niveau en een threshold van 5."}

# Importeer mock1_kraken_bracken_species_threshold5.png
nanoplot_not_filtered <-  rasterGrob(as.raster(readPNG("~/dsfb2/dsfb2_workflows_portfolio/dsfb2_workflows_portfolio/projecten/2_vrije_opdracht/verslag/mock1_kraken_bracken_species_threshold5.png")))
grid.arrange(nanoplot_not_filtered, ncol=1, top=textGrob("", gp=gpar(fontsize=20,font=8)))
