...
\
\
Het doel van deze opdracht is dat ik een metagenomics workflow kan toepassen op een realistische dataset en dat ik aanvullende statistische testen uitvoer op de 16s sequencing data.
\
...
-Controleren wat de workflow voor de projecticum dataset was bij Projecticum Biomolecular Research. \
...
Ik laat zien dat deze skill geleerd is door de code te laten zien die ik heb gebruikt of zelf heb gemaakt, waarbij ik bij elke stap heb toegelicht wat er is uitgevoerd. Verder laat ik de output van mijn code zien aan de hand van krona visualisaties, tabellen en grafieken (staafdiagram + lijngrafiek). Daarnaast laat ik zien dat deze workflow op andere datasets kan worden toegepast door deze workflow toe te passen op de metagenomics mock1 dataset van de daur2 module. Als laatste houd ik een README bij voor deze opdracht, waarin ik toelicht waar elk bestand voor deze opdracht voor dient.
