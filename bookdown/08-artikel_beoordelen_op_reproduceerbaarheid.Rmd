...
```{r inmporteer data, message=FALSE}
...
```{r ggplot, fig.cap='Aantal mensen van 18-64 jaar die tussen week 40 van 2023 en week 15 waren overleden aan influenza in de Verenigde Staten.'}
