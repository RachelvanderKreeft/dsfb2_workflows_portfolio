...
````{r, echo=FALSE, fig.width = 15, fig.height = 5, fig.cap="Lengte van de nanopore sequencing reads uitgezet tegen de kwaliteit van de reads van de ongefilterde data." }
...
````{r, echo=FALSE, fig.width = 15, fig.height = 5, fig.cap="Lengte van de nanopore sequencing reads uitgezet tegen de kwaliteit van de reads. Voor dit figuur werd gefilterd op >Q10 en een lengte van 1200 tot 1600 bp." }
...
```{r, echo=FALSE, fig.cap="Krona visualisatie op species niveau en een threshold van 0."}
...
```{r, echo=FALSE, fig.cap="Krona visualisatie op species niveau en een threshold van 5."}
...
```{r, echo=FALSE, fig.cap="Krona visualisatie van de patiëntensamples. De Krona visualisatie bevat in totaal 453 bacteriesoorten. Het figuur was tot stand gekomen tijdens het projecticum."}
...
```{r, echo=FALSE, fig.cap="Krona visualisatie van de controlesamples. De Krona visualisatie bevat in totaal 673 bacteriesoorten. Het figuur was tot stand gekomen tijdens het projecticum."}
...
```{r, echo=FALSE, fig.cap="Krona visualisatie op species niveau en een threshold van 50."}
...
```{r, echo=FALSE, fig.cap="Krona visualisatie op basis van kraken2 data op species niveau en een threshold van 0."}
